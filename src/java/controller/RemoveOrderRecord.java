...
public class RemoveOrderRecord extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public RemoveOrderRecord() 
    {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		try
		{
			...
			else 
			{
				...
				if(orderM.removeOrderRecord(oid)!=1)
				{
				...
				else
				{
					...
					response.sendRedirect("AdminOrdersHistory");
				}
			}
		}
		catch(Exception e)
		{
			System.out.println("System Error : RemoveOrderRecord : " + e);
		}
	}
